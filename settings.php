...
function sdwc_register_settings_page() {
    add_options_page(
        esc_html__( 'WC Review Captcha Settings', 'spam-defender-wooreview-captcha' ),
        esc_html__( 'WC Review Captcha', 'spam-defender-wooreview-captcha' ),
        'manage_options',
        'sdwc-settings',
...
function sdwc_settings_page_html() {
    ...
    ?>
    <div class="wrap">
        <h1><?php echo esc_html__('WC Review Captcha Settings', 'spam-defender-wooreview-captcha'); ?></h1>
        <form method="post" action="options.php">
            <?php settings_fields('sdwc_settings_group'); ?>
            <?php do_settings_sections('sdwc-settings'); ?>
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php esc_html_e('Site Key', 'spam-defender-wooreview-captcha'); ?></th>
                    <td><input type="text" name="sdwc_recaptcha_keys[site_key]" value="<?php echo esc_attr($keys['site_key']); ?>" size="50"/></td>
                </tr>
                <tr valign="top">
                    <th scope="row"><?php esc_html_e('Secret Key', 'spam-defender-wooreview-captcha'); ?></th>
